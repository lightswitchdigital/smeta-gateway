...
//        System.out.println(sheetZak.getSheetName());
        ...
        try {
            this.exporter.smetaZak(request, evaluator, sheetZak, smetaZak);
        } catch (IOException e) {
        ...
        try {
            this.exporter.smetaInternal(request, evaluator, sheetInternal, smetaInternal);
        } catch (IOException e) {
            this.logger.error("could not create pdf file: {}", e.getMessage());
        }
...
//        System.out.println(sheetZakRassh.getSheetName());
        ...
        try {
            this.exporter.smetaZakRassh(request, evaluator, sheetZakRassh, smetaZakRassh);
        } catch (IOException e) {
            this.logger.error("could not create pdf file: {}", e.getMessage());
        }
