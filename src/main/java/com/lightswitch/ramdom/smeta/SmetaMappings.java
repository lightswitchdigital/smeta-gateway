...
import com.lightswitch.ramdom.smeta.mappings.smeta.Cell;
import com.lightswitch.ramdom.smeta.mappings.smeta.Cells;
...
public class SmetaMappings {

    Logger logger = LoggerFactory.getLogger(SmetaMappings.class);

    public Cells mappings;

    public SmetaMappings() {
        this.load();
    }
